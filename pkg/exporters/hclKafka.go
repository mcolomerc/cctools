...
func NewHclKafkaExporter() *HclKafkaExporter {
	return &HclKafkaExporter{
		HclExporter: HclExporter{},
	}
}

func (e HclKafkaExporter) ExportTopics(topics []model.Topic, outputPath string) error {
